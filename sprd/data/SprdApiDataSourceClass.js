define(["js/data/RestDataSource", "underscore", "sprd/data/SprdModel", "sprd/model/processor/DefaultProcessor", "sprd/model/processor/BasketProcessor", "sprd/model/processor/BasketItemProcessor", "js/data/Model", "js/data/Collection"],
    function (RestDataSource, _, SprdModel, DefaultProcessor, BasketProcessor, BasketItemProcessor, Model, Collection) {
            ...
            getQueryParameter: function (method, resource) {
                ...
                if (this.$.session) {
                    ...
                    if (configuration.$.sessionRequired) {
                        ...
                        params = _.defaults({
                            sig: SprdApiDataSource.SHA1(data),
                            time: time,
                            sessionId: sessionId,
                            apiKey: apiKey
                        });
        ...
        SprdApiDataSource.SHA1 = function SHA1(msg) {
